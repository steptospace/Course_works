...
if __name__ == '__main__':
    ...
    info_pass, conn, key = test_server_for_android_app.connect_to_app() # получили Чип от android app
    #Send CHIP to Server DB

    data, signed_2_db = Policemen.client(public_key, private_key, info_pass)
    #data - photo
    hash_from_app = test_server_for_android_app.Zero_knowladge_proof(data, conn, key) #photo
